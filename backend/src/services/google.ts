...
/**
 * Verifies a Google ID token (issued to our web client) and returns the
 * identity. The token is validated for signature, issuer, audience and expiry
 * by the Google auth library against Google's public certificates.
 */
